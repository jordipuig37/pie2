...
f2'= Y ~ X + M # model aditiu però una variable és un factor en realitat
...
*scatterplot(formula(factorial), data)* ploteja la variable resposta vs la variable en una recta per cada factor. Si la fórmula és d'un model aditiu es veu només una recta.
...
Pels errors podem veure amb la funció plot i el parametre *which* = 1.
...
Ara veiem el plot dels residus. Recorda que s'ha de veure una distribució uniforme sobre el pla. Si es veu alguna forma d'embut cal aplicar transformacions.

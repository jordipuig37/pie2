...
# bandes
plot(ddt$DIES,ddt$H,pch=3,xlim=c(0,150),xlab="dies",ylab="H",ylim=c(min(dd$H,prd^2),max(dd$H,prd^2)),main="Model D")
...
### Test Levene
Serveix per comprovar la hipòtesis d'Homocedasticitat 
```{r}
...
Podem fer una taula per comparar diferents models, per exemple els que han sortit:
```{r}
rbind(
